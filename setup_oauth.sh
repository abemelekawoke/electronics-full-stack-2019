#!/bin/bash
# Setup script for Parrot Advert OAuth (Third-Party Login)
# 
# This script helps configure Google and Facebook OAuth credentials
# for the Parrot Advert Electronics Store.
#
# Prerequisites:
# 1. Google OAuth: Go to https://console.cloud.google.com/
#    - Create a project
#    - Enable Google+ API or Google People API
#    - Create OAuth 2.0 credentials (Client ID and Secret)
#    - Add redirect URI: http://localhost:8000/auth/google/login/callback/
#
# 2. Facebook OAuth: Go to https://developers.facebook.com/
#    - Create an app
#    - Add Facebook Login product
#    - Add redirect URI: http://localhost:8000/auth/facebook/login/callback/
